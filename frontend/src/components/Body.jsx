...
export default function Body() {
    ...
    const [allData, setAllData] = React.useState([{_id: 1, forecasts: forecastsData.forecasts, date: formatDatetime(forecastsData.forecasts[0].period_end)}]);
    ...
    const initialData = allData[0]; // sorted by descending order
